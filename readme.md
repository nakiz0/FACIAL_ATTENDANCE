...
![Password Reset Request](screenshots/reset_password.png)

---

### Email Sent for Password Reset
Secure password reset link sent to the user’s email.  
![Email to Reset Password](screenshots/email_to_reset.png)

---

### Set New Password
User sets a new password via a secure, time-limited token.  
![Set New Password](screenshots/new_password.png)

---

### Password Reset Confirmation
Confirmation screen after successful password update.  
![Password Reset Confirmation](screenshots/new_password_request.png)
...
![Attendance Marked Mail](screenshots/attendance_maked_mail.png)
...
![Attendance Capture](screenshots/attendance_remark.png)

---

### Already Marked Attendance
Prevents duplicate attendance marking for the same day.  
![Already Marked](screenshots/already_remarked.png)
...
![Manual Attendance](screenshots/manual_attendance_marking.png)
...
![Timetable](screenshots/time_table.png)

---

### Updating Timetable Entries
Admins can add, edit, or delete timetable entries dynamically.  
![Updating Timetable](screenshots/updating_time_table.png)
